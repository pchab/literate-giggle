...
export function BattleCard({
	...
	return (
		<motion.div
			onClick={onClick}
			className={`
                relative w-card h-card rounded border border-zinc-700/80 overflow-hidden shadow-lg
		...
		>
			...
			<div className="absolute inset-0 z-20 flex flex-col justify-end items-center pb-2 px-1 pointer-events-none">

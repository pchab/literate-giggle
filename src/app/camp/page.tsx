    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center bg-zinc-950 text-zinc-100 relative overflow-hidden">
            ...
            <div className="z-10 flex flex-col items-center">
                ...
                <p className="text-zinc-400 mb-12 italic text-sm">A brief moment of respite in a hostile world.</p>
                ...
                <div className="flex gap-6 mb-12">
                    {roster.map(hero => (
                        <div key={hero.id} className="flex flex-col items-center">
                            ...
                            <span className="text-xs font-bold mt-2 text-zinc-400">{hero.currentHp} / {hero.maxHp} HP</span>
                        </div>
                    ))}
                </div>
                ...
                type="button"
                    ...
                    >
                        ...
                        <span className="font-bold text-sm tracking-widest text-zinc-300 group-hover:text-green-400 transition-colors">REST</span>
                        <span className="text-[10px] text-zinc-500 mt-1">Recover 30% HP</span>
                    </button>
                ...
                type="button"
                    ...
                    >
                        ...
                        <span className="font-bold text-sm tracking-widest text-zinc-300 group-hover:text-amber-400 transition-colors">TRAIN</span>
                        <span className="text-[10px] text-zinc-500 mt-1">Upgrade Cards</span>
                    </button>
                </div>
            </div>

		...
		locations: [
			{
				...
				type: "SCENE",
				defaultSceneId: sceneId("ironhold_tavern"),
				position: { x: 44, y: 36 },
			},
			{
				id: townLocationId("ironhold_inn"),
				name: "Ironhold Inn (Rest)",
				type: "HEAL",
				position: { x: 48, y: 50 },
			},
			{
		...
		locations: [
			{
				...
				type: "SCENE",
				defaultSceneId: sceneId("cromee_tavern"),
				position: { x: 22, y: 60 },
			},
			{
				id: townLocationId("cromee_inn"),
				name: "Cromee Inn (Rest)",
				type: "HEAL",
				position: { x: 40, y: 42 },
			},
		],
		...
		locations: [
			{
				...
				name: "Ye Olde Pants Tavern",
				type: "SCENE",
				defaultSceneId: sceneId("connury_tavern"),
				position: { x: 22, y: 60 },
			},
			{

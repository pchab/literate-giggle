...
export const SHADOWS_DEBT_SCENES: Record<Scene["id"], Scene> = {
	[SHADOWS_DEBT.scenes.vane_intro]: {
		id: SHADOWS_DEBT.scenes.vane_intro,
				...
				choices: [
					{
						...
						actions: [
							{ type: "SET_FLAG", flagId: "vane_contract_signed" },
							{
								...
								newStepId: SHADOWS_DEBT.steps.hunt_the_wolf,
							},
							{ type: "END_SCENE" },
						],
					},
	...
	[SHADOWS_DEBT.scenes.wolf_ambush]: {
		id: SHADOWS_DEBT.scenes.wolf_ambush,
		initialStepId: "intro",
		steps: {
			intro: {
	...
	[SHADOWS_DEBT.scenes.wolf_victory]: {
		id: SHADOWS_DEBT.scenes.wolf_victory,
						...
						actions: [
							{
								type: "ADVANCE_QUEST",
								questId: SHADOWS_DEBT.id,
								newStepId: SHADOWS_DEBT.steps.report_to_vane,
							},
							{ type: "END_SCENE" },
						],
					},
	...
	[SHADOWS_DEBT.scenes.report_to_vane]: {
		id: SHADOWS_DEBT.scenes.report_to_vane,
				...
				choices: [
					{
						...
						actions: [
							...
							{ type: "COMPLETE_QUEST", questId: SHADOWS_DEBT.id },
